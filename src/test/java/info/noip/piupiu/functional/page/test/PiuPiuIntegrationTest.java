...
public class PiuPiuIntegrationTest {
	...
	public static void setupBeforeSuite() {
		...
		proc = new HttpCommandProcessor(seleniumHost,
				Integer.parseInt(seleniumPort), seleniumBrowser, seleniumUrl);
	...
	public void shouldNotLogin() {
		...
		assertTrue(page
				.verificarTextoPresente("- Usuário e/ou senha incorretos."));
	}

	@Test
	public void shouldLogin() {
		page.acessarPagina();
		page.login("luiseugenio@miltecnologia.com.br", "12345");
		assertTrue(page
				.verificarTextoPresente("Logado como luiseugenio@miltecnologia.com.br"));
	}
	...
	public void shouldPesquisarUsuario() {
		...
		assertTrue(page.verificarTextoPresente("eduardohitek@gmail.com"));
	}
